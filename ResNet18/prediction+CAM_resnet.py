...
finalconv_name='layer4' #last convolutional layer of our model
...
#original image
plt.subplot(1,2,1)
plt.imshow(img[0][0], vmax = 0.05, cmap='afmhot')
...
plt.subplot(1,2,2)
plt.imshow(img[0][0], vmax = 0.1, cmap='gray', alpha=1) # for image
xmin, xmax = plt.xlim()
ymin, ymax = plt.ylim()
